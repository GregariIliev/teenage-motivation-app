        ...
        <div className='form-container'>
            <form className="form">
                ...
                <div className="auth-buttons mt-4 w-100">
                    <button onClick={user.loginUserWhitEmailAndPassword} className="btn w-100" type="button">Login</button>
                    <button onClick={user.authUserWhitFacebook} className="btn w-100">
